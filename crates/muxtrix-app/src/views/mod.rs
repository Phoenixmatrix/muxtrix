//! The GPUI view layer: application state in, elements out.
//!
//! Rendering stays separate from the framework-agnostic application core:
//! interactions emit [`crate::app::Message`] values and the core decides what
//! they mean.
